...
import com.chris.registry.security.oauth2.SimpleAuthoritiesExtractor;
import com.chris.registry.security.oauth2.SimplePrincipalExtractor;
...
public class OAuth2SecurityConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/services/**").permitAll()   //modify by wei.li
